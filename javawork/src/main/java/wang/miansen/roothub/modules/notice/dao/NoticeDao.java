package wang.miansen.roothub.modules.notice.dao;
...
public interface NoticeDao {
	 ...
	 * @return
	 */
	int selectIdByNoticeAuthorIdAndTargetAuthorName(@Param("noticeAuthorId") Integer noticeAuthorId,@Param("targetAuthorName") String targetAuthorName);
}
