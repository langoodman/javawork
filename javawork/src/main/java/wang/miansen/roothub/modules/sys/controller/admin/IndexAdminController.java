...
public class IndexAdminController {
	...
	public String login(@RequestParam("username")String username,@RequestParam("password")String password,@RequestParam(value="checkbox",defaultValue = "0") Boolean rememberMe,Model model) {
		try {
			// 添加用户认证信息
			Subject subject = SecurityUtils.getSubject();
			if(!subject.isAuthenticated()) {
	...
	public String error() {
		return "/default/admin/error/error";
	}
