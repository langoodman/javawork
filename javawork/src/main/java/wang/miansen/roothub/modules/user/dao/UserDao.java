...
public interface UserDao {
	 ...
	 * @return
	 */
	User findByThirdToken(@Param("thirdAccessToken") String thirdAccessToken);

	/**
	 * @param userId
	 * @param password
	 */
	void UpdatePasswordById(@Param("userId")Integer userId, @Param("password")String password);
