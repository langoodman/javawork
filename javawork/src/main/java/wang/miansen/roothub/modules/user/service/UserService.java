...
public interface UserService {
	...
	UserExecution createUser(String username,String password,String email,String sex);
	 ...
	 * @return
	 */
	User selectByThirdToken(@Param("thirdAccessToken") String thirdAccessToken);
