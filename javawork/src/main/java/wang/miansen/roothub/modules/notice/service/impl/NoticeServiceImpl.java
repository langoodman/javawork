...
public class NoticeServiceImpl implements NoticeService{
	...
	public int deleteByNoticeId(Integer noticeId) {
		return rootNoticeDao.deleteByNoticeId(noticeId);
	}

	@Override
	public int selectIdByNoticeAuthorIdAndTargetAuthorName(Integer noticeAuthorId, String targetAuthorName) {
		return rootNoticeDao.selectIdByNoticeAuthorIdAndTargetAuthorName(noticeAuthorId, targetAuthorName);
	}
